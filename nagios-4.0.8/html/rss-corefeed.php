...
function do_corefeed_html() {
	...
	$rss = fetch_rss('https://www.capitalone.com/backend/feeds/corepromo');
	...
	if ($rss && $rss->items) {
		...
		$html = "Unable to fetch the Nagios Core feed. Stay on top of what's happening by visiting <a href='https://www.capitalone.com/' target='_blank'>https://www.capitalone.com/</a>.";
	}
