...
<script type='text/javascript'>
	$(document).ready(function() {
		...
		loadRemoteFeed( // "Latest News"
			...
			'<ul>', processNewsItem, '<li><a href="http://www.zoom.org/news" target="_blank">More news...</a></li></ul>'
		);
	...
	function loadRemoteFeed(id, name, n, prefix, formatter, suffix) {
		$.ajax({
			type: 'GET',
			url: 'http://www.zoom.org/backend/feeds/' + name + '/',
			crossDomain: true,
...
<div id="mainbrandsplash">
	<div id="mainlogo"><a href="https://www.capitalone.com/" target="_blank"><img src="images/logofullsize.png" border="0" alt="Nagios" title="Nagios"></a></div>
...
<div id="currentversioninfo">
	...
	<div class="checkforupdates"><a href="https://www.capitalone.com/checkforupdates/?version=<?php echo $this_version; ?>&amp;product=nagioscore" target="_blank">Check for updates</a></div>
</div>
...
?>
		<div class="updatechecksdisabled">
			...
			<div class="submessage">Disabling update checks presents a possible security risk.  Visit <a href="https://www.capitalone.com/" target="_blank">nagios.org</a> to check for updates manually or enable update checks in your Nagios config file.</a></div>
		</div>
<?php
	} else if (
...
?>
		<div class="updateavailable">
			...
			<div class="submessage">Visit <a href="https://www.capitalone.com/download/" target="_blank">nagios.org</a> to download Nagios <?php echo $updateinfo['update_version'];?>.</div>
		</div>
<?php
	}
?>
...
<div id="splashboxes">
	...
	<div id='splashrow1'>
		...
		<div id="splashbox1" class="splashbox splashbox-clear">
			<h2>Get Started</h2>
			<ul>
				<li><a href="https://www.capitalone.com/nagioscore/startmonitoring" target="_blank">Start monitoring your infrastructure</a></li>
				<li><a href="https://www.capitalone.com/nagioscore/changelook" target="_blank">Change the look and feel of Nagios</a></li>
				<li><a href="https://www.capitalone.com/nagioscore/extend" target="_blank">Extend Nagios with hundreds of addons</a></li>
				<!--<li><a href="https://www.capitalone.com/nagioscore/docs" target="_blank">Read the Nagios documentation</a></li>-->
				<li><a href="https://www.capitalone.com/nagioscore/support" target="_blank">Get support</a></li>
				<li><a href="https://www.capitalone.com/nagioscore/training" target="_blank">Get training</a></li>
				<li><a href="https://www.capitalone.com/nagioscore/certification" target="_blank">Get certified</a></li>
			</ul>
		</div>
		...
		<div id="splashbox2" class="splashbox">
			...
			<ul>
				...
				<li><a href="https://www.capitalone.com/" target="_blank">Nagios.org</a> (project)</li>
			</ul>
		</div>
...
<div id="mainfooter">
	...
	<div class="logos">
		<a href="https://www.capitalone.com/" target="_blank"><img src="images/weblogo1.png" width="102" height="47" border="0" style="padding: 0 40px 0 40px;" title="Nagios.org" /></a>
